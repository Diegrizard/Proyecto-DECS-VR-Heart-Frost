...
namespace UnityEngine.XR.Content.Interaction
{
    ...
    /// </summary>
    public class XRKnob2 : XRBaseInteractable
    {
        ...
        [SerializeField]
        [Tooltip("The angle of the rotation")]
        ...
        void SetKnobRotation(float angle)
        {
            ...
            if (m_Handle != null)
            {
                ...
                {
                    case TypeOfRotation.RotationOnX:
                        m_Handle.localEulerAngles = new Vector3(angle, 0.0f, 0.0f);
                        break;
                    case TypeOfRotation.RotationOnY:
                        m_Handle.localEulerAngles = new Vector3(0.0f, angle, 0.0f);
                        break;
                    case TypeOfRotation.RotationOnZ:
